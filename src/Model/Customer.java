...
public class Customer {
    ...
    public Customer(String id, String name, String birthday, String gender, String idCard, String phone, String email, String customerType, String address, String serviceUse) {
        this.id = id;
        this.name = name;
